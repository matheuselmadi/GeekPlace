...
import com.example.geekplace.DetailSerieActivity;
...
public class SeriesAdapter extends RecyclerView.Adapter<SeriesAdapter.ViewHolder> {
    private ArrayList<ResultSerie> movies;
    private LayoutInflater layoutInflater;
    private Context context;
    public SeriesAdapter(Context context, List<ResultSerie> movies) {
        this.movies = (ArrayList<ResultSerie>) movies;
    ...
    public void onBindViewHolder( SeriesAdapter.ViewHolder holder, int position) {
        holder.nome.setText(movies.get(holder.getAdapterPosition()).getName());
        holder.datalancamento.setText(movies.get(holder.getAdapterPosition()).getFirstAirDate());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, DetailSerieActivity.class);
                Bundle bundle = new Bundle();
                bundle.putSerializable("serie", movies.get(holder.getAdapterPosition()));
